...
Payoneer.prototype.request = function(data, forceArray, callback) {
  data = data || {};
...
Payoneer.prototype.getAuthRedirectURL = function(payeeID, callback) {
  ...
  this.request(data, false, callback);
};
...
Payoneer.prototype.getUnclaimedPayments = function(callback) {
  ...
  this.request(data, true, callback);
};
...
Payoneer.prototype.echo = function(callback) {
  this.request({ mname: ECHO }, false, callback);
};

Payoneer.prototype.getVersion = function(callback) {
  this.request({ mname: GET_VERSION }, false, callback);
};
